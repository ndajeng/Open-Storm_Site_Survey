"""
Package initializer for Open-Storm site survey form.

Nicholas Jeng <ndajeng@umich.edu>
"""
import flask
...
# Read settings from config module (survey/config.py)
...
import survey.views  # noqa: E402  pylint: disable=wrong-import-position
